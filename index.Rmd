...
Overall, Fiber to the Home provides the best value for consumers, with cable not far behind. DSL and Fixed Wireless have the worst value on average. While small FTTH ISPs, like Google Fiber, typically provide better value than larger fiber ISPs, this is not true for other technologies. 
